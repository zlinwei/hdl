...
set_property -dict {PACKAGE_PIN L21 IOSTANDARD LVCMOS18} [get_ports enable]
set_property -dict {PACKAGE_PIN M16 IOSTANDARD LVCMOS18} [get_ports txnrx]

set_property -dict {PACKAGE_PIN T16 IOSTANDARD LVCMOS18} [get_ports gpio_status[0]]
set_property -dict {PACKAGE_PIN N17 IOSTANDARD LVCMOS18} [get_ports gpio_status[1]]
set_property -dict {PACKAGE_PIN N18 IOSTANDARD LVCMOS18} [get_ports gpio_status[2]]
set_property -dict {PACKAGE_PIN M15 IOSTANDARD LVCMOS18} [get_ports gpio_status[3]]
set_property -dict {PACKAGE_PIN K19 IOSTANDARD LVCMOS18} [get_ports gpio_status[4]]
set_property -dict {PACKAGE_PIN K20 IOSTANDARD LVCMOS18} [get_ports gpio_status[5]]
set_property -dict {PACKAGE_PIN R15 IOSTANDARD LVCMOS18} [get_ports gpio_status[6]]
set_property -dict {PACKAGE_PIN T17 IOSTANDARD LVCMOS18} [get_ports gpio_status[7]]

set_property -dict {PACKAGE_PIN B22 IOSTANDARD LVCMOS18} [get_ports gpio_ctl[0]]
set_property -dict {PACKAGE_PIN G16 IOSTANDARD LVCMOS18} [get_ports gpio_ctl[1]]
set_property -dict {PACKAGE_PIN A22 IOSTANDARD LVCMOS18} [get_ports gpio_ctl[2]]
set_property -dict {PACKAGE_PIN D21 IOSTANDARD LVCMOS18} [get_ports gpio_ctl[3]]

set_property -dict {PACKAGE_PIN T19 IOSTANDARD LVCMOS18} [get_ports gpio_en_agc]
set_property -dict {PACKAGE_PIN H15 IOSTANDARD LVCMOS18} [get_ports gpio_resetb]

set_property -dict {PACKAGE_PIN  G19  IOSTANDARD LVCMOS18} [get_ports gpio_sync]  

set_property -dict {PACKAGE_PIN  H20  IOSTANDARD LVCMOS18} [get_ports gpio_clksel]

set_property  -dict {PACKAGE_PIN  R18  IOSTANDARD LVCMOS18  PULLTYPE PULLUP} [get_ports spi_csn]
set_property  -dict {PACKAGE_PIN  T18  IOSTANDARD LVCMOS18} [get_ports spi_clk]             
set_property  -dict {PACKAGE_PIN  P16  IOSTANDARD LVCMOS18} [get_ports spi_mosi]  
set_property  -dict {PACKAGE_PIN  R16  IOSTANDARD LVCMOS18} [get_ports spi_miso]  

set_property  -dict {PACKAGE_PIN  R19  IOSTANDARD LVCMOS18} [get_ports clkout_in] 

# iic

set_property  -dict {PACKAGE_PIN  F21   IOSTANDARD LVCMOS18 PULLTYPE PULLUP} [get_ports iic_scl]        
set_property  -dict {PACKAGE_PIN  F22   IOSTANDARD LVCMOS18 PULLTYPE PULLUP} [get_ports iic_sda]        
